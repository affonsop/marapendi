...
:meth:`~marapendi.channel.gas_transport_resistance.ChannelGasResistanceModel.total_resistance`),
gives
...
(:attr:`~marapendi.channel.flow_channels.FlowChannel.hydraulic_diameter`),
:math:`Sh` = :attr:`~marapendi.channel.gas_transport_resistance.ChannelGasResistanceModel.sherwood`,
:math:`D` the binary diffusion coefficient, :math:`L, W` the channel
length/width, ``ch/land`` = :attr:`~marapendi.channel.flow_channels.FlowChannel.channel_land_ratio`
the channel-to-land width ratio, :math:`n_\mathrm{ch}` =
:attr:`~marapendi.channel.flow_channels.FlowChannel.n_parallel` the number of
parallel channels, :math:`B_\mathrm{ch}` a fitted convective pre-factor
(:attr:`~marapendi.channel.gas_transport_resistance.ChannelGasResistanceModel.B_ch`),
...
(:attr:`~marapendi.channel.flow_channels.FlowChannel.half_width`,
:attr:`~marapendi.channel.gas_transport_resistance.BakerChannelGasResistanceModel.A_ch`)
...
channels
(:attr:`~marapendi.channel.flow_channels.FlowChannel.total_flow_section`),
...
(:meth:`~marapendi.channel.gas_transport_resistance.ChannelGasResistanceModel.gas_transport_resistance`)
