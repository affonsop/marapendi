...
(:attr:`~marapendi.simulation.state.GasState.saturation_concentration` and
:attr:`~marapendi.simulation.state.GasState.vapor_concentration`) and :math:`R_v` the (dry)
