...
dataclasses (:class:`~marapendi.dynamic.components.ionomer.Ionomer`,
:class:`~marapendi.dynamic.components.membrane.Membrane`) as explicit arguments
...
from marapendi.dynamic.models.electrochemistry import enthalpy_condensation
from marapendi.tools.tools import arrhenius_term, polyval_vec
from marapendi.dynamic.models.water import water_molecular_weight, water_molar_volume, water_density
