...
:mod:`marapendi.dynamic.models.membrane` (``IonomerModel``, ``MembraneModel``,
``PFSAModel``).
"""
...
from marapendi.dynamic.components.ionomer import Ionomer, PFSAIonomer
...
class Membrane(PorousLayer, Ionomer):
    ...
    Combines porous-layer geometry (:class:`~marapendi.dynamic.components.porous_layers.PorousLayer`)
    with ionomer material parameters (:class:`~marapendi.dynamic.components.ionomer.Ionomer`).
    ...
    :mod:`marapendi.dynamic.models.membrane`.
