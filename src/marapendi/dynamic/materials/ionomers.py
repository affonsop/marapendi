...
"""
from marapendi.dynamic.components.ionomer import PFSAIonomer, Ionomer
import numpy as np

Nafion_N11X = PFSAIonomer(
...
Nafion_N21X = PFSAIonomer(
    rho_dry_ion=2.0 * 1e3,                                         # kg/m³
    EW_ion=1100,                                         # kg/kmol
    darken_num_ion=np.array([1, 0.1367, 0.008828, -6.734e-3, 5.740e-4]),
    darken_den_ion=np.array([1, -0.1196, 0.03711, -1.176e-3, 5.740e-4, 0.0]),
