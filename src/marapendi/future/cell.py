...
:class:`~marapendi.future.membrane.Membrane`.

This module currently only defines the dataclasses and the lists used
to loop over their components. Orchestration of the calculations is
left to :class:`marapendi.future.model.CellModel`.
"""
