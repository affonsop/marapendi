...
:class:`FlowChannel` extends :class:`~marapendi.future.porous_layers.PorousLayer`
with the geometric properties of a gas flow channel.

This module currently only defines the dataclass and its static
...
from ..legacy.transport_models import ChannelGasResistanceModel
