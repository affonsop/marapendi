"""
Parameter estimation glue between :mod:`marapendi.future` cell models and
experimental datasets.

Classes
-------
Case
    One experimental case: a :class:`~marapendi.future.cell.Cell`, its
    :class:`~marapendi.future.conditions.CellOperatingConditions`, and a
    dict of experimental data arrays.
ParameterEstimation
    Simulates :class:`Case` objects with a
    :class:`~marapendi.future.model.CellModel` and assembles simulated /
