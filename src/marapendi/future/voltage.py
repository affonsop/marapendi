...
:class:`~marapendi.future.cell.Cell` for a given :class:`~marapendi.future.state.CellState`,
porting :class:`marapendi.legacy.voltage.VoltageModel` to operate on
``(Cell, CellState)`` instead of a ``FuelCell``/``FuelCellState`` snapshot.
"""
...
from ..legacy.electrochemistry import calculate_reversible_cell_voltage, STD_PRESSURE
from ..legacy.water import water_molar_volume
