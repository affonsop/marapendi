...
:class:`~marapendi.future.porous_layers.PorousLayer` with the
...
from ..legacy.electrochemistry import ElectrochemicalReaction
from ..legacy.ionomer import CatalystLayerIonomer, PFSAIonomer
from ..legacy.water import o2_water_diffusivity
