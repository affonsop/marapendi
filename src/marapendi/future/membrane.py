...
generic ionomer correlations from :class:`~marapendi.future.ionomer.Ionomer`
...
:class:`marapendi.future.state.MembraneState` and are produced/consumed by
:class:`marapendi.future.water_balance.MembraneWaterBalanceModel`.
"""
...
from ..legacy.membrane_permeation_models import HydrogenPermeationModel
