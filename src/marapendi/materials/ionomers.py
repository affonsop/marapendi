...
Nafion_N21X = Ionomer(
    dry_density=2.0 * 1e3,                                         # kg/m³
    equivalent_weight=1100,                                         # kg/kmol
    darken_num=np.array([1, 0.1367, 0.008828, -6.734e-3, 5.740e-4]),
    darken_den=np.array([1, -0.1196, 0.03711, -1.176e-3, 5.740e-4, 0.0]),
    sorption_isotherm_coeffs=np.array([0.0, 14.25, -23.95, 21.11]),
    reference_liquid_equilibrium_water_content=22,                  # kmol_H2O/kmol_ion
...
Fumapem_FAA3 = Ionomer(
    ...
    reference_water_diffusivity=0.577 * 2.72e-5 * 1e-4,            # m²/s — FAA-3-50
    reference_desorption_coefficient=0.0448 * 4.59e-2 * 1e-2,      # m/s  — FAA-3-50
    ionomer_activation_energy=2.07 * 20e6,                                  # J/kmol — FAA-3-50
)
