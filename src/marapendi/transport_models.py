"""
Gas and liquid transport models.

Channel and porous-media gas transport resistance models, and the
Darcy two-phase (capillary-pressure / saturation) transport model.
"""
