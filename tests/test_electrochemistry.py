...
def test_reversible_cell_voltage():
    assert  np.isclose(mrpd.calculate_reversible_cell_voltage(temperature=298.15, partial_pressure_o2=1e5, partial_pressure_h2=1e5), 1.229, 1e-3)
    assert  np.isclose(mrpd.calculate_reversible_cell_voltage(temperature=353.15, partial_pressure_o2=.2e5, partial_pressure_h2=2e5), 1.1805, 1e-3)
