from marapendi.cell import CellSide
from marapendi.gas import GasModel
from marapendi.state import CellSideState
from marapendi.transport import GasTransportModel
...
def _side_state_at(side: CellSide, temperature: float) -> CellSideState:
    ...
    for layer_state in state.layers:
        ...
        GasModel.set_composition(layer_state, dry_o2_mole_fraction=0.21, dry_h2_mole_fraction=0., relative_humidity=0.5,
                                  inlet_pressure=1.5e5, inlet_temperature=temperature)
